...
const PAGE_TEMPLATE = (title, navHtml, contentHtml) => `<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8">
...
function main() {
  ...
  console.log('Diagrams render via Mermaid loaded from a CDN — open with internet access, or the raw diagram code still reads fine without it.');
}
