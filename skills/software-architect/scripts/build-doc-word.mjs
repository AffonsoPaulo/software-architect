...
function renderFiles(files) {
  ...
  for (const f of files) {
    rtf += renderMarkdownToRtf(f.content, { namespace: f.namespace, resolveLink }).rtf + '\n';
  }
  return rtf;
}
...
export function buildDocWord(projectRoot, outputPath) {
  ...
  parts.push(
    ...
    '{\\field{\\*\\fldinst { TOC \\\\o "1-3" \\\\h \\\\z \\\\u }}{\\fldrslt {\\i Right-click here and choose "Update Field" (or press F9) to generate the table of contents.\\i0}}}\n' +
    '\\par\\page'
  );
