...
- [ ] Every `API-XXX` (`docs/09-api-design/`) has an explicit authentication/authorization statement recorded (including "public, no auth") — checked by `scripts/validate-traceability.mjs`
