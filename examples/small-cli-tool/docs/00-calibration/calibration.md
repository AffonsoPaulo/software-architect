...
| 11 — Security | included | Always mandatory, even for a small tool (file-handling still needs a stated position on trust boundaries). |
| 12 — Testing | included | |
...
| 11 — Security | included | Always mandatory — confirms the new format doesn't introduce a new trust boundary (it doesn't; same local-file model). |
| 12 — Testing | included | One new test plan. |
| 14 — Roadmap | included | New small milestone. |
| 15 — Backlog | included | |
| 16 — Implementation Plan | included | |
| 17 — Review | included | Always mandatory, every cycle. |
