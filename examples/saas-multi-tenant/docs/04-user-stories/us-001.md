...
Must respect REQ-003's tenant isolation from the first line of code — see the Special cases note in `docs/05-use-cases/uc-001.md` about building this tenant-safe rather than retrofitting it.
